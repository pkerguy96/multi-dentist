...
import { fetchObservationApiClient } from "../../services/ObservationService";

const ObservationPageView = () => {
  ...
  const { data, isLoading } = obsID
    ? getGlobalById(
        {},
        [CACHE_KEY_Patientobservation, id],
        fetchObservationApiClient,
        undefined,
        parseInt(id)
      )
...
export default ObservationPageView;
