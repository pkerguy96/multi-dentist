...
const NotificationComponent = () => {
  ...
  const handleNotification = useCallback(() => {
    ...
    queryClient.refetchQueries(CACHE_KEY_Notification);
    setRefetchInterval(false);
  }, [queryClient]);
  usePusher("Operation-is-active", "OperationActive", handleNotification);
  const unreadCount =
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Box className="flex flex-row gap-2"></Box>
        </Box>
